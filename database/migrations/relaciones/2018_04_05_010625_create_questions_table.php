...
class CreateQuestionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('questions', function (Blueprint $table) {
            ...
            $table->string('sugerencia',250)->nullable();
            $table->enum('enterar', ['FACEBOOK','YOUTUBE','TWITTER','PAGINA WEB','']);
            $table->string('medios',250)->nullable();
            $table->enum('informacion', ['BVC','PUNTO BVC','UNIVERSIDAD','AMIGO','']);
            $table->string('medios1',250)->nullable();
